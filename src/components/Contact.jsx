    ...
    <div name="contact" className="w-full min-h-screen bg-[#111111] flex justify-center items-center p-4">
      <div className="flex flex-col justify-center items-center w-full h-full text-white">
        <div className="max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4">
          <div>
            <p className="text-4xl lg:text-7xl font-bold">Contact <span className="text-[#10C623]">Me</span></p>
            <p className="text-3xl pb-2 pt-4">If You Have Any Project In Mind</p>
            <p>
            ...
            <div className="flex justify-start space-x-4 my-4 animate-bounce">
